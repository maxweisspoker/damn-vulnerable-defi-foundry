...
in the space, you get a somewhat strange response from their server. Here’s a
snippet:
...
Starting with just 0.1 ETH in balance, pass the challenge by obtaining all ETH
available in the exchange.


See the contracts:
https://github.com/tinchoabbate/damn-vulnerable-defi/tree/v3.0.0/contracts/compromised
